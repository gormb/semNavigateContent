...
big6.push([820000,800000,'Social and Cultural Biases:','Social and cultural biases arise from our interactions with others and the societal norms we internalize. These biases can affect design decisions by influencing our preferences, beliefs, and understanding of users. Recognizing and addressing these biases is crucial to creating inclusive and user-centered designs that resonate with diverse audiences.','','','','']);
...
big6.push([840000,800000,'Emotional and Psychological Biases:','Emotional and psychological biases stem from our emotions, attitudes, and self-perceptions. They can influence how we perceive and interact with design elements. Understanding these biases is essential for creating emotionally engaging and empathetic designs that resonate with users on a deeper level.','','','','']);
...
big6.push([865000,860000,' Feature fatigue ',' Overwhelming users with too many features or options, leading to confusion and decreased engagement. ','Hvorfor dette skjer og hvorfor det er bra: Overambitious design disregards user needs, simplification aids UX, reduces waste, fosters inclusivity, and enhances user satisfaction.','Hvorfor dette ikke skjer og hvorfor det er bra: User-centered approach avoids complexity, optimizes resources, enhances efficiency, promotes sustainable design, and elevates user experience.','Hvorfor dette skjer og hvorfor det er skadelig: Poor design decisions prioritize quantity over quality, leading to confusion, waste, frustration, and negative environmental impact.','Hvorfor dette ikke skjer og hvorfor det er skadelig: Overlooking user needs hinders UX, increases digital clutter, wastes resources, and negatively impacts user satisfaction and the environment.']);
